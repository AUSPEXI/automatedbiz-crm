...
import { Mail, Brain, Plus } from 'lucide-react';

const EmailAI: React.FC = () => {
  const { user } = useAuth();
  ...
  if (loading) return <div>Loading email campaigns...</div>;

  return (
    <div className="space-y-6 p-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">Email AI Dashboard</h1>
